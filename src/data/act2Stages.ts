...
export const ACT2_STAGES: readonly StageSlideData[] = [
  ...
  },
  {
    ...
    caseClient: 'Коли інструменти працюють у звʼязці',
    caseResult: 'AI-асистент приймає запит → бот підтверджує → бекофіс виставляє рахунок. Команда працює з людьми, а не з копіюванням даних.',
    caseTechChips: ['AI-асистент', 'Чатбот', 'Автоматизація'],
  },
  {
    stageIndex: 5,
